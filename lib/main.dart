...
class CalculatorState extends State<Calculator> {
  ...
  Widget _button(text, double paddingBot) {
    return Padding(
      ...
      child: Material(
        ...
        color: Color.fromRGBO(90, 90, 160, 1),
        child: CircleAvatar(
  ...
  Widget _buildFancyButton(text, {bool isTop = false, bool isBottom = false}) {
    return Container(
      margin: EdgeInsets.fromLTRB(0, isTop ? 7 : 7, 7, isBottom ? 0 : 0),
      child: Material(
          ...
          Expanded(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border(
                  bottom: BorderSide(
                    color: Color.fromRGBO(227, 27, 27, 1),
                  ),
                ),
              ),
              child: Row(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        InkWell(
                          ...
                          onTap: () => {_buttonPressed("x", isClear: true)},
                          child: Container(
                            alignment: Alignment.center,
                            height: 45,
                            width: 45,
